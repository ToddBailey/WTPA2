...
#define	Om_FLASH_CS			(1<<PD5)	// Chip select to flash daughterboard.

// EXTERNAL FLASH STUFF IS ON THIS PORT.  Its pins are defined in the appropriate library/header.
