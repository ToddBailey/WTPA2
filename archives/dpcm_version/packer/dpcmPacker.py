...
print len(sys.argv)
if (len(sys.argv) != 3)	 :
	print "This tool gathers all files regardless of extension in the ./samples directory and arranges a bank usable by the DPCM code."
	print "Each bank can hold up to 128 4KB samples."
	print "Usage : dpcmPacker.py <sample directory> <output file>"
	sys.exit(1)
print ""

fileList = glob.glob(sys.argv[0] + "/*.*")
