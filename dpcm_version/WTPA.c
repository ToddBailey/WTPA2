...
//static unsigned int
	//sampleLength[128]  // 2 byte value representing length of corresponding sample
						 // Values are retrieved from a block immediately following the 512KB of sample data
static unsigned char
